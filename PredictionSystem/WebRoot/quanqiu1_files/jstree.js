	...
	$.jstree.core.prototype = {
		...
		bind : function () {
			...
			this.element
				...
				.on("dblclick.jstree", ".jstree-anchor", $.proxy(function (e,data) {
						if(e.target.tagName && e.target.tagName.toLowerCase() === "input") { return true; }
						if(this.settings.core.dblclick_toggle) {
							this.toggle_node(e.target);
						}
						this.edit_node(e.currentTarget, e);
					}, this))
                ...
                //.on("dbclick.jstree", ".jstree-anchor", $.proxy(function (e) {
                //    alert(3)
                //    e.preventDefault();
                //    if (e.currentTarget !== document.activeElement) { $(e.currentTarget).focus(); }
		...
		// hhhhhh
		edit_node : function (obj, e) {
		    obj = this.get_node(obj);
		    this.trigger('edit_node', { 'node': obj, 'event': e });
		    //console.log(obj);
		    //return obj;
            //this.trigger('edit_node', { 'node': obj, 'selected': this._data.core.selected, 'event': e });
