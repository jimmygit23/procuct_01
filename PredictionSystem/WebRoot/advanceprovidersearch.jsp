...
<style> 
 ...
 <div id="printAreaGoble">
	...
	function sendseccessucr(idstr){
						alert(1111);
							var xhrstr = xmlhttp.responseText;
							var index = xhrstr.indexOf('<body>');
							var lastindex = xhrstr.indexOf('</body>');
							xhrstr = xhrstr.substring(index,lastindex+7);
