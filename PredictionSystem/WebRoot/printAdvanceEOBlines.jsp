...
<html>
	...
	<body>
		<table style="margin-top:50px;margin-left:100px" id="initPrintArea"  width="100%" border="0" cellpadding="10" cellspacing="0">
			<tr> 
				<td>
				   <input type="button" value="Go Back" id="goback" >
				   <input type="button" style="margin-left:940px" value="Print Advance EOB" id="idPrintGoble" name="thisPage"/>
					<table cellspacing="1" cellpadding="3" width="1150px" border="0" bgcolor="#0089C7">
						<tr>
							<th colspan="6">
						...
						<tr>
							<td class="tdclass6_1" colspan="4">12. PATIENT'S OR AUTHORIZED PERSON'S SIGNATURE <br>
						    	<!--<input type="text" name="adveob" id="adveob12" size="50" value="${eobdetailobj.releaseofinformation }" class="input001_1">  -->
							...
							<td class="tdclass6_1" colspan="2">13. INSURED'S OR AUTHORIZED PERSON'S SIGNATURE <br>
								<input type="text" name="adveob" id="adveob13" size="50"  class="input001_1"  value="${eobdetailobj.assignment_of_benefits }" >
							</td>
						</tr>
						<!-- 
						<tr>
						...
						<tr>
							<td class="tdclass6_1" colspan="2">17. NAME OF REFERRING PROVIDER OR OTHER SOURCE <br>
								...
								-->
								<input type="text" name="adveob" id="adveob17_1" class="input001_1"  value="${eobdetailobj.referring_provider_fname }" class="input001_1">
								<input type="text" name="adveob" id="adveob17_2" class="input001_1" value="${eobdetailobj.referring_provider_mname }" class="input001_1">
								<input type="text" name="adveob" id="adveob17_3" class="input001_1" value="${eobdetailobj.referring_provider_lname}" class="input001_1">
								<input type="text" name="adveob" id="adveob17_4" class="input001_1" value="${eobdetailobj.referring_provider_suffix }" class="input001_1">
							</td>
							<td class="tdclass6_1" colspan="2">
								<!-- 17a. 
						...
						<tr>
							<td class="tdclass6_1" colspan="2"  >31. ORDERING PHYSICIAN 
								...
								<br><br><input type="text" name="adveob" id="adveob31" class="input001_1" value="${eobdetailobj.rendering_provider_fname }" class="input001_1" onfocus="" onblur="" style="">
								<input type="text" name="adveob" id="adveob31_1" class="input001_1" value="${eobdetailobj.rendering_provider_mname }" class="input001_1" onfocus="" onblur="" style="">
								<br><br><input type="text" name="adveob" id="adveob31_2" class="input001_1" value="${eobdetailobj.rendering_provider_lname }" class="input001_1" onfocus="" onblur="" style="">
								<input type="text" name="adveob" id="adveob31_3" class="input001_1" value="${eobdetailobj.rendering_provider_suffix }" class="input001_1" onfocus=""  onblur="" style="">
