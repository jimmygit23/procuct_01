		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td align="center" valign="middle" class="Tabmenu3"
					onmouseover="this.className='Tabmenu5'"
					onmouseout="this.className='Tabmenu3'">
					<a href="#" id="menu_2" class="Tabmenu3">Provider Demographics</a>
				</td>
			</tr>
			<tr>
				<td>
...
$("#menu_1")
		.click(
				function() {
					window.location.href = "<%=request.getContextPath()%>bk/bk_proSearch.do?tab_flag=tab_7&menu_id=menu_1";
				});
$("#menu_2")
		.click(
				function() {
				$("#backhome").attr({"action":"https://secure.achonline.com/brokers/providerdemographics_input.asp","target":"_blank"});
				$("#backhome").submit();
				});
</script>
</html>
