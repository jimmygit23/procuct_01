...
$("#tab_5").click(function (){
	//window.location.href="https://secure.achonline.com/customerservice/providersearch.asp?sub_number33=${grpno}&emp_number33=${empno}&userno=${sessionUser.usernumber}&loginType=${sessionUser.loginType}"; 
