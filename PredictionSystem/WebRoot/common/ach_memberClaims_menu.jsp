		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td height="26px;" align="center" valign="middle" class="Tabmenu3"
					onmouseover="this.className='Tabmenu5'"
					onmouseout="this.className='Tabmenu3'">
					<a href="#" id="menu_2" class="Tabmenu3">List All<br>Claims</a>
				</td>
			</tr>
			<tr>
				<td height="26px;" align="center" valign="middle" class="Tabmenu3"
					onmouseover="this.className='Tabmenu5'"
					onmouseout="this.className='Tabmenu3'">
					<a href="#" id="menu_3" class="Tabmenu3">Claim Form</a>
				</td>
			</tr>
			<tr>
				<td>
...
$("#menu_1").click(function(){
	window.location.href = "<%=request.getContextPath()%>/mem/mem_initClaimPage.do?tab_flag=tab_4&menu_id=menu_1";
});

//List All Claims
$("#menu_2").click(function(){
	//window.open("https://www.achonline.com/members/claimlist.asp?login=${sessionUser.login}&password=${sessionUser.password}");
	window.location.href = "<%=request.getContextPath()%>/claim/claim_showlist.do?tab_flag=tab_4&menu_id=menu_1&type=1";
});
...
$("#menu_3").click(function(){
  ...
  //  $("#backhome1").submit();
	//window.open("https://secure.achonline.com/members/claimform.asp?login=${sessionUser.login}&password=${sessionUser.password}");
		window.location.href = "<%=request.getContextPath()%>/mem/mem_cliamform.do?grpno=${grpno}&empno=${empno}&tab_flag=tab_4&menu_id=menu_3&type=1";
