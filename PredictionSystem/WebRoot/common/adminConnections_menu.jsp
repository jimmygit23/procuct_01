...
$("#menu_2")
		.click(
				function() {
					window.location.href = "<%=request.getContextPath()%>/admin/adm_adminForms.do?tab_flag=tab_6&menu_id=menu_2";
				});
...
$("#menu_5")
		.click(
				function() {
					window.location.href = "<%=request.getContextPath()%>/admin/adm_adminIndustry.do?tab_flag=tab_6&menu_id=menu_5";
				});
...
$("#menu_3")
		.click(
				function() {
						window.location.href="<%=request.getContextPath()%>/employee/emp_uploadFile.do?grpno=${grpno}&empno=${empno}&tab_flag=tab_6&menu_id=menu_3";
				});
//Projects
$("#menu_4")
		.click(
				function() {
						window.location.href="<%=request.getContextPath()%>/employee/emp_adminProject.do?grpno=${grpno}&empno=${empno}&tab_flag=tab_6&menu_id=menu_4&filetype=projreport";
				});
</script>
</html>
