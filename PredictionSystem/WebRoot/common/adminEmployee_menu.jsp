...
$("#menu_2")
		.click(
				function() {
				    ...
				    //window.open("${sessionUser.oldurl}/admin/enrollmentlist.asp?login=${sessionUser.login}&password=${sessionUser.password}");
				 });
...
$("#menu_4")
		.click(
				function() {
				    ...
				    //window.open("https://secure.achonline.com/newta/admin/ChangesHistory.asp?login=${sessionUser.login}&password=${sessionUser.encpassword}");
