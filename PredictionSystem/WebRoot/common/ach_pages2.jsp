		...
		if(event.keyCode==13){
               goto_page();
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
						<th align="right" >
                                      <span style="font-size: 12px">每页<s:select list="{10,15,20,50}" id="psize" name="pageBean.maxResults" onchange="go_page(1)" theme="simple"  cssStyle="width: 40px"/>
                                      	行&nbsp;第${pageNo}页/共${totalPage}页
                                      &nbsp;&nbsp;共${rowCount}条记录</span>							
								<s:if test="pageNo==1">
								...
								<span style="font-size: 12px">转到</span>
								<input type="text" id="sel"  style="width: 40px" value="${pageNo }" onblur="value=value.replace(/[^(\d)]/g,'')" onkeyup="replace(this.value)" maxlength="4"/>
