...
$("#tab_3")
		.click(
				function() {
					...
					//window.open("https://secure.achonline.com/members/providersearch.asp?login=${sessionUser.login}&password=${sessionUser.password}");
				   //$("#backhome1").attr({"action":"https://secure.achonline.com/members/providersearch.asp","target":"_blank"});
	                           //$("#backhome1").submit();
				});
