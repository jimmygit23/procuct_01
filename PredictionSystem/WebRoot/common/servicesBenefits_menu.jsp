...
//
 ...
 $("#menu_1").click(function(){
  ...
  $("#menu_3").click(function(){
	//window.location.href="<%=request.getContextPath()%>/employee/emp_uploadFile.do?grpno=${grpno}&empno=${empno}&tab_flag=tab_2&menu_id=menu_5";
   //window.open("https://secure.achonline.com/customerservice/benefits_results_test.asp?sub_number33=${grpno}&emp_number33=${empno}&loginType=${sessionUser.loginType}");
...
$("#menu_4").click(function(){
	window.open("https://secure.achonline.com/newta/customerservice/DocumentPostings.asp?sub_number33=${grpno}&emp_number33=${empno}&loginType=${sessionUser.loginType}");
});
